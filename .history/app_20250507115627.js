...
const menuCad = () => {
  ...
  switch (opcao) {
    case "C":
      const cadastro = readline.question("Digite o que voce quer armazenar");
      if (cadastro) {
        memoria.push(cadastro);
    ...
    case "U":
      console.log(memoria);
      const item = readline.question("Qual item voce quer atualizar");
      if(memoria[item] !== undefined){
        memoria[item] = readline.question("Digite o novo item");
      }
      break;
    case "D":
      console.log("Exclua");
