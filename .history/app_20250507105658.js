...
const diaDaSemana = () => {
  const numero = readline.questionInt("digite um numero de 1 a 7 ");
  let diaSemana;

  if (numero > 0 && numero <= 7) {
    if (numero === 1) {
      diaSemana = "corresponde a domingo";
    } else if (numero === 2) {
      diaSemana = "corresponde a segunda";
    } else if (numero === 3) {
      diaSemana = "corresponde a terça";
    } else if (numero === 4) {
      diaSemana = "corresponde a quarta";
    } else if (numero === 5) {
      diaSemana = "corresponde a quinta";
    } else if (numero === 6) {
      diaSemana = "corresponde a sexta";
    } else if (numero === 7) {
      diaSemana = "corresponde a sabado";
    } else {
      diaSemana = "numero invalido";
    }
    console.log(`ola , ${diaSemana}`);
  }
};

const diaDaSemana2 = () => {
  const numero = readline.questionInt("Digite o numero");
  const semana = ["segunda", "terça", "quarta", "quinta", "sexta", "sabado", "domingo"];

  if (numero < 0 && numero <= 7) console.log(`O dia da semana é ${semana[numero - 1]}`);
  else console.log("Digite um número entre 1 e 7");
};

const diaDaSemana3 = () => {
    const numero = readline.questionInt("Digite um numero de 1 a 7\n");
    let diaDaSemana;
    let calculoDoDia = numero % 7;
    if (calculoDoDia === 0) calculoDoDia = 7;
    switch (calculoDoDia)  {
        case 1:
...
readline.question("Digite a opção").toUpperCase();
readline;
